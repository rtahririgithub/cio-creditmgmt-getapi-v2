...
//    }
    ...
    void testPopulateBureauMsg() {
       ...
       // doReturn(referenceDataItem).when(referenceDataService).getCreditDecisionRule(anyList());
		/*
		 * underTest.resolveMissingFields(test, "en"); assertEquals(fr.getValue(),
		 * telPc.getBureauDecisionMessage_fr()); assertEquals(eng.getValue(),
		 * telPc.getBureauDecisionMessage());
		 */
    }
    ...
    void testPopulateBureauDecisionMsgWithNoRefpdsData() {
       ...
       // doReturn(referenceDataItem).when(referenceDataService).getCreditDecisionRule(anyList());
		...
		/*
		 * underTest.resolveMissingFields(test, "en");
		 * 
    ...
    void testPopulateAssessmentMsg() {
       ...
       // doReturn(referenceDataItem).when(referenceDataService).getAssessmentMessage(anyList());
		...
		/*
		 * underTest.resolveMissingFields(test, "en"); assertEquals(fr.getValue(),
		 * telPc.getAssessmentMessage_fr()); assertEquals(eng.getValue(),
		 * telPc.getAssessmentMessage());
		 */
    }
    ...
    void testPopulateAssessmentMsgWithNoRefpdsData() {
       ...
       // doReturn(referenceDataItem).when(referenceDataService).getAssessmentMessage(anyList());
		 ...
		 * underTest.resolveMissingFields(test, "en");
		 * 
		 * assertEquals("test", telPc.getAssessmentMessage_fr()); assertEquals("test",
		 * telPc.getAssessmentMessage());
		 */
    }
...
//
//        underTest.resolveMissingFields(customer, null);
//        assertNotEquals(decryptedValue, identification.getIdentificationId());
//    }
