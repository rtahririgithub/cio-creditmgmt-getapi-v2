...
public class CorrelationIdFilter implements Filter {
	...
	private boolean validateToken(HttpServletRequest httpRequest) {
		...
		String auth = httpRequest.getHeader(CommonConstants.HEADER_AUTHORIZATION);
		boolean valid = false;
		if (StringUtils.isNotBlank(auth) && StringUtils.startsWith(auth, CommonConstants.BEARER)) {
