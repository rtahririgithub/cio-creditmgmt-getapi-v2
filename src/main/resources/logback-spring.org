    ...
    <springProfile name="default">
		...
		<appender name="FLAT-FILE-APPENDER" class="ch.qos.logback.core.rolling.RollingFileAppender">
			...
			<encoder class="ch.qos.logback.classic.encoder.PatternLayoutEncoder">
				<Pattern>[%d{yyyy-MM-dd HH:mm:ss.SSS}]:[%X{correlationId}][%X{requestId}][%X{containerId}][%thread][%-40logger{40}][logseveritylevel=%-5level]:%mask(%msg) %n</Pattern>
			</encoder>
       ...
       <conversionRule conversionWord="mask" converterClass="com.telus.credit.advice.LogMaskConverter" />
        ...
        <appender name="CONSOLE-APPENDER" class="ch.qos.logback.core.ConsoleAppender">
            <encoder>
				...
				<Pattern>[%d{yyyy-MM-dd HH:mm:ss.SSS}]:[%X{correlationId}][%X{requestId}][%cyan(%-20logger{20})][logseveritylevel=%-5level]:%mask(%msg) %n</Pattern>
			</encoder>
		</appender>
